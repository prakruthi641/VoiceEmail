...
def process(uname):
        ...
        #choices details
        if text == '1' or text == 'One' or text == 'one' or text == 'compose' or text =='Compose':
                print("Choice one")
                ...
                while(text1==""):
                        ...
                        if text1=="":
                                ...
                                playsound(ttsname)
                                os.remove(ttsname)
                if text1 == '1' or text1 == 'One' or text1 == 'one' or text1=='attachment' or text1=='Attachment':
                        smaila.process(uname)
                if text1 == '2' or text1 == 'tu' or text1 == 'two' or text1 == 'Tu' or text1 == 'to' or text1 == 'To' or text1 == 'do' or text1 == 'Do'or text1=='simple' or text1=='Simple' :
                        sMail.process(uname)
        if text == '2' or text == 'tu' or text == 'two' or text == 'Tu' or text == 'to' or text == 'To' or text == 'do' or text == 'Do' or text=='read' or text=='Read' or text=='check' or text=='Check' or text=='c h e c k' :
                print("Choice two")
                rMail.process(uname)
        if text == '3' or text == 'th' or text == 'thr' or text == 'Th' or text == 'thre' or text == 'Three' or text=='exit' or text=='Exit':
                print("Choice three")
                exit()
#process('demo')  
