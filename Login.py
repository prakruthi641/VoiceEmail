...
def process():
        ...
        message1 = tk.Label(window, text="Voice based Email System", bg=bgcolor, fg=fgcolor, width=50, height=3, font=('Helvetica', 40, 'bold'))
        ...
        lbl = tk.Label(window, text="User Name", width=20, height=2, fg=fgcolor, bg=bgcolor, font=('times', 20, 'bold'))
        lbl.place(x=150, y=150)  # Adjusted x and y coordinates

        txt = tk.Entry(window, width=20, bg="white", fg="black", font=('times', 20, 'bold'))
        txt.place(x=450, y=165)  # Adjusted x and y coordinates

        # Password Label and Entry
        lbl1 = tk.Label(window, text="Password", width=20, height=2, fg=fgcolor, bg=bgcolor, font=('times', 20, 'bold'))
        lbl1.place(x=150, y=250)  # Adjusted x and y coordinates

        txt1 = tk.Entry(window, width=20, bg="white", fg="black", font=('times', 20, 'bold'))
        txt1.place(x=450, y=265)  # Adjusted x and y coordinates
